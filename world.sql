...
-- Exportiere Struktur von Tabelle world.city
...
-- Exportiere Daten aus Tabelle world.city: ~3.910 rows (ungefähr)
DELETE FROM `city`;
...
-- Exportiere Struktur von Tabelle world.country
...
-- Exportiere Daten aus Tabelle world.country: ~239 rows (ungefähr)
DELETE FROM `country`;
...
-- Exportiere Struktur von Tabelle world.countrylanguage
...
-- Exportiere Daten aus Tabelle world.countrylanguage: ~984 rows (ungefähr)
